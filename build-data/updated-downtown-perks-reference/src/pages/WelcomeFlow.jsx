    ...
    <div className="min-h-screen bg-gradient-to-b from-bgMain to-bgAlt flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="mb-12">
              ...
              return (
                ...
                >
                  ...
                  <p className={`text-xs font-medium text-center ${
                    isCurrent ? 'text-navy' : 'text-textMuted'
                  }`}>
                    {step.title}
                  </p>
                </motion.div>
          ...
          {/* Progress Bar */}
          <div className="w-full h-1 bg-bgAlt rounded-full overflow-hidden">
            <motion.div
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <Card className="border-gold/30 shadow-soft">
              <CardHeader>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <Button
            onClick={handleNext}
            disabled={loading}
            className="flex-1 bg-gold hover:bg-goldSoft text-navy font-semibold"
          >
            {loading ? (
...
function PerksStep({ formData, setFormData }) {
  return (
    <div className="space-y-4">
      <p className="text-sm text-textSecondary">
      ...
      <div className="bg-gold/10 border border-gold/30 rounded-lg p-4">
        <h4 className="font-semibold text-navy mb-3">Program Benefits</h4>
      ...
      <div className="flex items-center gap-3 p-4 border border-gold/20 rounded-lg cursor-pointer"
        onClick={() => setFormData({ ...formData, perksEnrolled: !formData.perksEnrolled })}>
        <Checkbox
          checked={formData.perksEnrolled}
          onChange={(checked) => setFormData({ ...formData, perksEnrolled: checked })}
        />
        <label className="text-sm font-medium text-navy cursor-pointer flex-1">
...
function PreferencesStep({ formData, setFormData }) {
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-3 p-4 border border-gold/20 rounded-lg cursor-pointer"
          ...
          <div className="flex-1">
            <label className="text-sm font-medium text-navy cursor-pointer block">
      ...
      <p className="text-xs text-textMuted bg-bgAlt p-3 rounded-lg">
