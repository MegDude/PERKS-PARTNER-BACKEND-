...
export const platformModuleAuditItems: PlatformModuleAuditItem[] = [
  ...
  },
  {
    ...
    status: "installed",
    notes: "Shows demand, coverage, response rate, and campaign opportunities.",
  },
  {
    id: "event-ingestion",
  ...
  },
  {
    ...
    status: "installed",
    notes: "Built as a real Google Sheets adapter with status, test, append, lead export, survey export, and retry support. Live provider auth uses the service-account env vars.",
  },
  {
    id: "map-validation",
  ...
  },
  {
    ...
    status: "installed",
    notes: "Implemented as a server-side Supabase REST client for table reads, inserts, updates, and deletes. It reports missing credentials clearly before any remote call.",
  },
  {
    id: "faq",
    label: "FAQ data",
  ...
  },
  {
    ...
    installedPath: "src/lib/googleSheets.ts",
    status: "installed",
    notes: "Base44 Sheets scope is now backed by the shared Google Sheets adapter and server endpoints. It can test credentials, append rows, export leads, and export survey responses.",
  },
  {
  ...
  },
  {
    ...
    status: "installed",
    notes: "Survey export now builds a clean response payload and sends it through the backend Google Sheets adapter with success, pending credentials, and failure states.",
  },
  {
    ...
    status: "installed",
    notes: "Management notifications now write directly into the platform backend, including survey, resident, building, perk, score, sentiment, and export status context.",
  },
  {
