            ...
            <CardContent className="text-slate-700 space-y-4">
              <ol className="space-y-3 list-none">
                <li className="flex items-start gap-3">
                  <span className="inline-flex items-center justify-center w-6 h-6 bg-primary text-white rounded-none text-sm font-bold flex-shrink-0">1</span>
                  <div>
                ...
                <li className="flex items-start gap-3">
                  <span className="inline-flex items-center justify-center w-6 h-6 bg-primary text-white rounded-none text-sm font-bold flex-shrink-0">2</span>
                  <div>
                ...
                <li className="flex items-start gap-3">
                  <span className="inline-flex items-center justify-center w-6 h-6 bg-primary text-white rounded-none text-sm font-bold flex-shrink-0">3</span>
                  <div>
                ...
                <li className="flex items-start gap-3">
                  <span className="inline-flex items-center justify-center w-6 h-6 bg-primary text-white rounded-none text-sm font-bold flex-shrink-0">4</span>
                  <div>
